...
namespace BetterHats
{
    public static class HatService
    {
        ...
        public delegate void OnTickDelegate(UpdateTickedEventArgs e);
        public static OnTickDelegate OnTickMethod;

        public delegate void OnTimeChangedDelegate(TimeChangedEventArgs e);
        public static OnTimeChangedDelegate OnTimeChangedMethod;
