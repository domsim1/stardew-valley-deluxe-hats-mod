            ...
            HatService.OnUpdateTicked = (e) =>
            {
                ...
                if (buff == null)
                {
                    ...
                    buff = new Buff(
                        ...
                        displaySource: HatService.GetTranslation("hat.squid-hat.name"),
                        displayName: HatService.GetTranslation("hat.squid-hat.buff.name"),
                        effects: effects
                        );
                    buff.description = HatService.GetTranslation("hat.squid-hat.buff.description");
