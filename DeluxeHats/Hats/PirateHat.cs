            ...
            HatService.OnUpdateTicked = (e) =>
            {
                ...
                if (buff == null)
                {
                    ...
                    buff = new Buff(
                        ...
                        displaySource: HatService.GetTranslation("hat.pirate-hat.name"),
                        displayName: HatService.GetTranslation("hat.pirate-hat.buff.name"),
                        effects: effects
                    );
                    buff.description = HatService.GetTranslation("hat.pirate-hat.buff.description");
